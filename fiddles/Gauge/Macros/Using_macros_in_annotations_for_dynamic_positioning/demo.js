FusionCharts.ready(function () {
    ...
    //Event for roll over on anchors
    visitChart.addEventListener('dataplotrollover', function (evtObj, argObj) {
    ...
    visitChart.addEventListener('dataplotrollout', function (evtObj, argObj) {
